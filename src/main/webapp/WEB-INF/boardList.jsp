        ...
        <c:forEach items="${sessionScope.desks}" var="desk">
            <tr class="TableDetail1">
                ...
                <td align="center">
                    <c:choose>
                        <c:when test="${desk.state eq 0}">
                            <a href="/InsertOrderServlet?deskId=${desk.id}&pageNum=${sessionScope.pageNumber}"
                               class="FunctionButton">预定</a>
                            <a href="/UpdateDeskServlet?olddeskname=${desk.name}&oldcontent=${desk.content}&pageNum=${sessionScope.pageNumber}"
                               class="FunctionButton">更新</a>
                            <a href="/DeleteDesk?deskId=${desk.id}&pageNum=${sessionScope.pageNumber}"
