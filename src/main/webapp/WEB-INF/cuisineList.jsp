    ...
    <table class="MainArea_Content" align="center" cellspacing="0" cellpadding="0">
        ...
        <c:forEach items="${sessionScope.foodSets}" var="foodset">
            <tr class="TableDetail1">
                <td align="center">${foodset.id}</td>
                <td align="center">${foodset.name}</td>
                <td align="center">
                    <a href="/UpdateSetServlet?oldset=${foodset.name}" class="FunctionButton">更新</a>
                    <a href="/DeleteFoodSetServlet?foodsetId=${foodset.id}&pageNum=${sessionScope.pageNumber}"
                       class="FunctionButton" onClick="return delConfirm();">删除</a>
                </td>
            </tr>
        </c:forEach>
        <%--<tr>--%>
        ...
        <%--<td>粤菜</td>--%>
        <%--<td>--%>
        <%--<a href="../detail/updateCuisine.jsp" class="FunctionButton">更新</a>--%>
